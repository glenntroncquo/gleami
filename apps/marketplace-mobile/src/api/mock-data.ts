...
export const MOCK_SALONS: MockSalon[] = [
  salon({
    ...
    images: [photo('photo-1560066984-138dadb4c035'), photo('photo-1522337360788-8b13dee7a37e')],
  ...
  salon({
    ...
    images: [photo('photo-1503951914875-452162b0f3f1'), photo('photo-1585747860715-2ba37e788b70')],
  ...
  salon({
    ...
    imageUrl: photo('photo-1487412947147-5cebf100ffc2'),
    images: [photo('photo-1487412947147-5cebf100ffc2'), photo('photo-1516975080664-ed2fc6a32937')],
  ...
  salon({
    ...
    imageUrl: photo('photo-1560066984-138dadb4c035'),
    images: [photo('photo-1519415387722-a1c3bbef716c'), photo('photo-1560066984-138dadb4c035')],
  ...
  salon({
    ...
    images: [photo('photo-1516975080664-ed2fc6a32937')],
