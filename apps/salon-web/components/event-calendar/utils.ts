...
export function getEventColorClasses(color?: EventColor | string): string {
  ...
  switch (eventColor) {
    ...
    case "lime":
      return "bg-lime-200/50 hover:bg-lime-200/40 text-lime-900/90 dark:bg-lime-400/25 dark:hover:bg-lime-400/20 dark:text-lime-200 shadow-lime-700/8";
    case "pink":
      return "bg-pink-200/50 hover:bg-pink-200/40 text-pink-900/90 dark:bg-pink-400/25 dark:hover:bg-pink-400/20 dark:text-pink-200 shadow-pink-700/8";
    case "indigo":
      return "bg-indigo-200/50 hover:bg-indigo-200/40 text-indigo-900/90 dark:bg-indigo-400/25 dark:hover:bg-indigo-400/20 dark:text-indigo-200 shadow-indigo-700/8";
    case "amber":
    ...
    case "teal":
      return "bg-teal-200/50 hover:bg-teal-200/40 text-teal-900/90 dark:bg-teal-400/25 dark:hover:bg-teal-400/20 dark:text-teal-200 shadow-teal-700/8";
    case "purple":
      return "bg-purple-200/50 hover:bg-purple-200/40 text-purple-900/90 dark:bg-purple-400/25 dark:hover:bg-purple-400/20 dark:text-purple-200 shadow-purple-700/8";
    default:
      return "bg-blue-200/50 hover:bg-blue-200/40 text-blue-900/90 dark:bg-blue-400/25 dark:hover:bg-blue-400/20 dark:text-blue-200 shadow-blue-700/8";
  }
}
